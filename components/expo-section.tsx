        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-sm font-mono text-white/30 mt-6 leading-relaxed max-w-md">
              {"Tathva'25 Interface is all about technology \u2014 the trending, the innovations, the age-old, and many more."}
            </p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={item.title}
                className="group border border-white/5 bg-[#0a0a0a] p-6 hover:border-green-500/20 transition-all duration-500 flex items-start gap-4"
              >
                <item.icon className="w-6 h-6 text-green-500/40 group-hover:text-green-500/70 transition-colors flex-shrink-0 mt-1" />
                <div>
