  ...
  return (
    <section id="gpc" className="relative py-0 bg-[#050505] overflow-hidden">
      ...
      <ScrollingMarquee
        ...
        className="py-4 border-y border-red-500/10 bg-[#080808]"
        textClassName="text-red-500/40"
      />

      <div className="relative py-24 px-4">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(239,68,68,0.06)_0%,transparent_60%)]" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative flex items-center justify-center">
              <div className="relative w-full max-w-sm aspect-square">
                ...
                <div className="absolute inset-6 border border-red-500/10 rotate-45" />
                <div className="absolute inset-12 border border-red-500/20 rotate-45" />

                {/* Center */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <Gamepad2 className="w-16 h-16 text-red-500/40 mx-auto" />
                    <p className="text-xs font-mono text-red-500/30 mt-4 tracking-[0.3em]">NEXUS</p>
                  </div>
                </div>

                {/* Corner dots */}
                <div className="absolute top-0 left-1/2 w-2 h-2 rounded-full bg-red-500/30 -translate-x-1/2 -translate-y-1/2" />
                <div className="absolute bottom-0 left-1/2 w-2 h-2 rounded-full bg-red-500/30 -translate-x-1/2 translate-y-1/2" />
                <div className="absolute left-0 top-1/2 w-2 h-2 rounded-full bg-red-500/30 -translate-x-1/2 -translate-y-1/2" />
                <div className="absolute right-0 top-1/2 w-2 h-2 rounded-full bg-red-500/30 translate-x-1/2 -translate-y-1/2" />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3 mt-16 justify-center">
            {Array(8)
              ...
              .map((text, i) => (
                <span
                  key={i}
                  className={`text-xs font-mono tracking-[0.3em] ${i % 2 === 0 ? "text-white/10" : "text-red-500/20"
                    }`}
                >
                  {text}
                </span>
