  ...
  return (
    <section id="robowars" className="relative py-0 bg-[#050505] overflow-hidden">
      ...
      <div className="relative py-24 px-4">
        {/* Radial glow */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(239,68,68,0.06)_0%,transparent_60%)]" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative flex items-center justify-center">
              <div className="relative w-72 h-72 md:w-96 md:h-96">
                ...
                {/* Middle ring */}
                <div className="absolute inset-6 rounded-full border border-red-500/20 animate-spin" style={{ animationDuration: "15s", animationDirection: "reverse" }} />
                {/* Inner ring */}
                <div className="absolute inset-12 rounded-full border border-red-500/30" />
                {/* Center icon */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-24 h-24 md:w-32 md:h-32 bg-red-500/5 rounded-full flex items-center justify-center border border-red-500/20">
                    <Bot className="w-12 h-12 md:w-16 md:h-16 text-red-500/60" />
                  </div>
                </div>
                {/* Floating labels */}
                <div className="absolute top-4 right-4 text-[8px] font-mono text-red-500/40 tracking-widest">
                  16x16 FT
                </div>
                <div className="absolute bottom-4 left-4 text-[8px] font-mono text-red-500/40 tracking-widest">
                  8KG \ 15KG
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <h2 className="text-6xl md:text-8xl font-sans font-bold tracking-tighter text-red-500/30 leading-none">
                WARS
              </h2>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm font-mono text-red-500">WORTH INR 8 LAKH</span>
                </div>
              </div>
