...
export default function ProniteSection() {
  ...
  return (
    <section id="pronite" className="relative py-24 px-4 bg-[#050505] overflow-hidden">
      {/* Background glow */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(239,68,68,0.05)_0%,transparent_60%)]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
            <div className="border border-white/5 bg-[#0a0a0a] p-6 flex flex-col justify-between aspect-square md:aspect-auto">
              ...
              <div>
                ...
                <p className="text-lg font-sans text-red-500/60 font-bold">Live it</p>
              </div>
            ...
            <div className="md:col-span-2 border border-white/5 bg-[#0a0a0a] p-8 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_center,rgba(239,68,68,0.08)_0%,transparent_70%)]" />
              <div className="relative z-10">
                <Music className="w-8 h-8 text-red-500/40 mb-4" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="relative aspect-square md:aspect-auto md:min-h-[400px] bg-[#080808] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="mt-4 w-20 h-20 mx-auto rounded-full border border-red-500/20 flex items-center justify-center">
                    <Music className="w-8 h-8 text-red-500/40" />
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 md:p-12 flex flex-col justify-between">
                ...
                <div className="mt-8 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <button
                      onClick={prevArtist}
                      className="w-10 h-10 border border-white/10 flex items-center justify-center hover:border-red-500/50 hover:text-red-500 transition-all text-white/40"
                  ...
                  <button className="text-[10px] font-mono text-red-500/60 tracking-widest hover:text-red-500 transition-colors">
                    SEE MORE {"-->"}
                  </button>
                </div>
              </div>
          ...
          <div className="flex mt-4 gap-2">
            {artists.map((artist, i) => (
              <button
                ...
                className={`flex-1 py-3 text-xs font-mono tracking-wider transition-all border ${i === activeArtist
